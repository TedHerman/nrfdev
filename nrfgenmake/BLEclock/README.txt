...
3-20-17
Tien notes: bleclock.c is the code that Ted wrote. The goal was to remove the "multiple GPIO triggers" when we pushed the button.
            The old code works fine, but triggers multiple times per button press, which could lead to problems.     
