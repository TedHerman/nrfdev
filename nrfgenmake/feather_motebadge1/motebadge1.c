...
// this array of pointers and the struct in the data section
// is for long term storage of data extracted from packet pool
...
struct batch {
  ...
  uint8_t num;     // number of reports that follow
...
// this packet pool is for the 8 seconds of accumulating
