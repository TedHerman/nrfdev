...
extern uint8_t nnqslotstate;
extern uint32_t ticksremain;
extern uint8_t nnqvect[3];
...
static inline void all_prec_update(void)
{
    ...
    do
    {
        ...
        if (prev_prio != new_prio)
        {
            ...
            {
		// hack by Ted Herman, remove hfclk stop    
            ...
            {
		// hack by Ted Herman, remove hfclk stop/start    
...
void nrf_raal_timeslot_started(void)
{
    ...
    // hack by Ted Herman, insert pretend hfclk ready signal
